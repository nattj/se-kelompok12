                ...
                <div class="row g-3 my-2">
                    ...
                    <form method="post" action="/doctor">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nid" name="nid" value="{{Session::get('nid')}}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="specialization" name="specialization" value="{{Session::get('specialization')}}">
                        </div>
                        <div class="mb-3">
