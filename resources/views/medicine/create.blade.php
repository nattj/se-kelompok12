                ...
                <div class="row g-3 my-2">
                    ...
                    <form method="post" action="/medicine">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="mid" name="mid" value="{{Session::get('mid')}}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="dosage" name="dosage" value="{{Session::get('dosage')}}">
                        </div>
                        <div class="mb-3">
                            <label for="usage" class="form-label">Usage</label>
                            <input type="text" class="form-control" id="usage" name="usage" value="{{Session::get('usage')}}">
                        </div>
                        <div class="mb-3">
                            <label for="price" class="form-label">Price</label>
                            <input type="text" class="form-control" id="price" name="price" value="{{Session::get('price')}}">
                        </div>
                        <div class="mb-3">
                            <label for="qty" class="form-label">Quantity</label>
                            <input type="text" class="form-control" id="qty" name="qty" value="{{Session::get('qty')}}">
                        </div>
