        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <a href="{{url('/patient/create')}}" class="btn btn-primary btn-md">Add New Patient</a>
                    <h3 class="fs-4 mb-3">Patients' Table</h3>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{$item->address}}</td>
                                    <td>
                                        <a class="btn btn-warning" href="{{url('/patient/'.$item->nik.'/edit')}}" class=>Edit</a>
                                        <form class="d-inline" action="{{'/patient/'.$item->nik}}" method="post">
                                            @csrf
                                            @method('delete')
